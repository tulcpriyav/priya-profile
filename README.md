...
[![Build Status](https://img.shields.io/github/actions/workflow/status/abhinavnarne/personal-site/node.js.yml?branch=main)](https://github.com/abhinavnarne/personal-site/actions)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](./LICENSE)
[![GitHub Stars](https://img.shields.io/github/stars/abhinavnarne/personal-site?style=social)](https://github.com/abhinavnarne/personal-site/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/abhinavnarne/personal-site?style=social)](https://github.com/abhinavnarne/personal-site/network/members)
...
**[See it live →](https://www.abhinavnarne.com)**
...
```bash
gh repo fork abhinavnarne/personal-site --clone
cd personal-site
npm install
npm run dev
```
