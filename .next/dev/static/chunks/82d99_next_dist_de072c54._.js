(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/shared/lib/router/utils/disable-smooth-scroll.js [app-client] (ecmascript)',
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/components/bfcache.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var MAX_BF_CACHE_ENTRIES = ('TURBOPACK compile-time falsy', 0)
    ...
    function useRouterBFCache(activeTree, activeStateKey) {
      ...
      var _ref = _sliced_to_array._(
        ...
        prevActiveEntry = _ref[0],
        setPrevActiveEntry = _ref[1];
  ...
  (__turbopack_context__, module, exports) => {
    ...
    var _disablesmoothscroll = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/shared/lib/router/utils/disable-smooth-scroll.js [app-client] (ecmascript)',
    );
    ...
    var _errorboundary1 = __turbopack_context__.r(
    ...
    var _bfcache = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/components/bfcache.js [app-client] (ecmascript)',
    );
     ...
     */ function findDOMNode(instance) {
      ...
      var internal_reactDOMfindDOMNode =
    ...
    var InnerScrollAndFocusHandler = /*#__PURE__*/ (function (
      ...
      function InnerScrollAndFocusHandler() {
        ...
        (_this = _call_super._(
          ...
          (_this.handlePotentialScroll = function () {
            ...
            var _this_props = _this.props,
              focusAndScrollRef = _this_props.focusAndScrollRef,
              segmentPath = _this_props.segmentPath;
            if (focusAndScrollRef.apply) {
              ...
              if (
                ...
                !focusAndScrollRef.segmentPaths.some(
                  function (scrollRefSegmentPath) {
                    return segmentPath.every(function (segment, index) {
                      return (0, _matchsegments.matchSegment)(
                        segment,
              ...
              while (
                !_instanceof._(domNode, HTMLElement) ||
                ...
                if (('TURBOPACK compile-time truthy', 1)) {
                  ...
                  if (
                    ((_domNode_parentElement = domNode.parentElement) ===
                      null || _domNode_parentElement === void 0
                      ? void 0
    ...
    function ScrollAndFocusHandler(param) {
      var segmentPath = param.segmentPath,
     ...
     */ function InnerLayoutRouter(param) {
      var tree = param.tree,
        ...
        debugNameContext = param.debugNameContext,
        maybeCacheNode = param.cacheNode,
        params = param.params,
        url = param.url,
      ...
      var parentNavPromises = (0, _react.useContext)(
      ...
      var resolvedPrefetchRsc =
        cacheNode.prefetchRsc !== null ? cacheNode.prefetchRsc : cacheNode.rsc;
      // We use `useDeferredValue` to handle switching between the prefetched and
      // final values. The second argument is returned on initial render, then it
      // re-renders with the first argument.
      var rsc = (0, _react.useDeferredValue)(
        cacheNode.rsc,
        resolvedPrefetchRsc,
      );
      ...
      if (('TURBOPACK compile-time truthy', 1)) {
        var createNestedLayoutNavigationPromises = __turbopack_context__.r(
     ...
     */ function LoadingBoundary(param) {
      ...
      if (
        (typeof loading === 'undefined' ? 'undefined' : _type_of._(loading)) ===
          'object' &&
        loading !== null &&
    ...
    function OuterLayoutRouter(param) {
      var parallelRouterKey = param.parallelRouterKey,
        ...
        templateStyles = param.templateStyles,
        templateScripts = param.templateScripts,
        template = param.template,
        notFound = param.notFound,
        forbidden = param.forbidden,
        unauthorized = param.unauthorized,
        segmentViewBoundaries = param.segmentViewBoundaries;
      var context = (0, _react.useContext)(
      ...
      var parentTree = context.parentTree,
        parentCacheNode = context.parentCacheNode,
        parentSegmentPath = context.parentSegmentPath,
        parentParams = context.parentParams,
        url = context.url,
        isActive = context.isActive,
        debugNameContext = context.debugNameContext;
      ...
      var activeStateKey = (0, _createroutercachekey.createRouterCacheKey)(
        activeSegment,
        true,
      ); // no search params
      ...
      var bfcacheEntry = (0, _bfcache.useRouterBFCache)(
        activeTree,
        activeStateKey,
      );
      var children = [];
      do {
        ...
        var cacheNode =
          (_segmentMap_get = segmentMap.get(cacheKey)) !== null &&
          _segmentMap_get !== void 0
            ? _segmentMap_get
            : null;
        /*
    - Error boundary
  ...
  */ var segmentBoundaryTriggerNode = null;
        ...
        if (('TURBOPACK compile-time truthy', 1)) {
          var _require = __turbopack_context__.r(
            ...
            SegmentBoundaryTriggerNode = _require.SegmentBoundaryTriggerNode,
            SegmentViewStateNode = _require.SegmentViewStateNode;
        ...
        if (Array.isArray(segment)) {
          ...
          var paramValue = (0, _routeparams.getParamValueFromCacheKey)(
            paramCacheKey,
            paramType,
          );
          if (paramValue !== null) {
            params = _object_spread_props._(
              _object_spread._({}, parentParams),
              _define_property._({}, paramName, paramValue),
            );
          }
        }
        ...
        var childDebugNameContext =
          debugName !== null && debugName !== void 0
            ? debugName
            : debugNameContext;
        ...
        var child = /*#__PURE__*/ (0, _jsxruntime.jsxs)(
        ...
        if (('TURBOPACK compile-time truthy', 1)) {
          var SegmentStateProvider = __turbopack_context__.r(
            '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/next-devtools/userspace/app/segment-explorer-node.js [app-client] (ecmascript)',
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/web/spec-extension/adapters/reflect.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/shared/lib/utils/reflect-utils.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    _export(exports, {
      describeHasCheckingStringProperty:
        function describeHasCheckingStringProperty1() {
    ...
    function describeHasCheckingStringProperty(target, prop) {
      ...
      return '`Reflect.has('
        .concat(target, ', ')
        .concat(stringifiedProp, ')`, `')
        .concat(stringifiedProp, ' in ')
        .concat(target, '`, or similar');
    }
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/search-params.browser.dev.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var _reflect = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/web/spec-extension/adapters/reflect.js [app-client] (ecmascript)',
    );
    var _reflectutils = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/shared/lib/utils/reflect-utils.js [app-client] (ecmascript)',
    );
        ...
        get: function get(target, prop, receiver) {
          if (typeof prop === 'string') {
            if (
              ...
              var expression = (0, _reflectutils.describeStringPropertyAccess)(
                'searchParams',
                prop,
              );
    ...
    function warnForSyncAccess(expression) {
      console.error(
        'A searchParam property was accessed directly with '.concat(
          expression,
          '. ',
        ) +
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/search-params.browser.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var createRenderSearchParamsFromClient = ('TURBOPACK compile-time truthy',
    1)
      ? __turbopack_context__.r(
          '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/search-params.browser.dev.js [app-client] (ecmascript)',
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/params.browser.dev.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    function warnForSyncAccess(expression) {
      console.error(
        'A param property was accessed directly with '.concat(
          expression,
          '. ',
        ) +
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/params.browser.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var createRenderParamsFromClient = ('TURBOPACK compile-time truthy', 1)
      ? __turbopack_context__.r(
          '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/params.browser.dev.js [app-client] (ecmascript)',
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/create-deduped-by-callsite-server-error-logger.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var _react = /*#__PURE__*/ _interop_require_wildcard(
      __turbopack_context__.r(
        '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)',
      ),
    );
    ...
    function _interop_require_wildcard(obj, nodeInterop) {
      ...
      if (
        obj === null ||
        ((typeof obj === 'undefined' ? 'undefined' : _type_of._(obj)) !==
          'object' &&
          typeof obj !== 'function')
      ) {
        return {
    ...
    // when enabled.
    var logErrorOrWarn = ('TURBOPACK compile-time falsy', 0)
      ? 'TURBOPACK unreachable'
      : console.warn;
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/after-task-async-storage-instance.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/after-task-async-storage.external.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var _aftertaskasyncstorageinstance = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/after-task-async-storage-instance.js [app-client] (ecmascript)',
    ); //# sourceMappingURL=after-task-async-storage.external.js.map
  },
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/request/utils.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    _export(exports, {
      isRequestAPICallableInsideAfter:
        function isRequestAPICallableInsideAfter1() {
          return isRequestAPICallableInsideAfter;
        },
      throwForSearchParamsAccessInUseCache:
        function throwForSearchParamsAccessInUseCache1() {
          return throwForSearchParamsAccessInUseCache;
        },
      throwWithStaticGenerationBailoutErrorWithDynamicError:
        function throwWithStaticGenerationBailoutErrorWithDynamicError1() {
    ...
    var _aftertaskasyncstorageexternal = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/after-task-async-storage.external.js [app-client] (ecmascript)',
    );
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/staged-rendering.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
      ...
      function StagedRenderingController() {
        ...
        var abortSignal =
            arguments.length > 0 && arguments[0] !== void 0
              ? arguments[0]
              : null,
          hasRuntimePrefetch = arguments.length > 1 ? arguments[1] : void 0;
      ...
      _create_class._(StagedRenderingController, [
            ...
            if (this.currentStage >= stage) {
              ...
              throw Object.defineProperty(
                new _invarianterror.InvariantError(
                  'Invalid render stage: '.concat(stage),
                ),
                '__NEXT_ERROR_CODE',
                {
                  value: 'E881',
        ...
        },
        {
          ...
          value: function delayUntilStage(stage, displayName, resolvedValue) {
            ...
            var promise = makeDevtoolsIOPromiseFromIOTrigger(
              ioTriggerPromise,
              displayName,
              resolvedValue,
            );
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/request/search-params.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    _export(exports, {
      createPrerenderSearchParamsForClientPage:
        function createPrerenderSearchParamsForClientPage1() {
      ...
      createServerSearchParamsForMetadata:
        function createServerSearchParamsForMetadata1() {
          return createServerSearchParamsForMetadata;
        },
      createServerSearchParamsForServerPage:
        function createServerSearchParamsForServerPage1() {
          return createServerSearchParamsForServerPage;
        },
      makeErroringSearchParamsForUseCache:
        function makeErroringSearchParamsForUseCache1() {
    ...
    var _creatededupedbycallsiteservererrorlogger = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/create-deduped-by-callsite-server-error-logger.js [app-client] (ecmascript)',
    );
    var _reflectutils = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/shared/lib/utils/reflect-utils.js [app-client] (ecmascript)',
    ...
    var _stagedrendering = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/staged-rendering.js [app-client] (ecmascript)',
    );
    ...
    var createServerSearchParamsForMetadata =
      createServerSearchParamsForServerPage;
    ...
    function makeHangingSearchParams(workStore, prerenderStore) {
      ...
      var promise = (0, _dynamicrenderingutils.makeHangingPromise)(
    ...
    function makeUntrackedSearchParamsWithDevWarnings(
      ...
      if (requestStore.asyncApiPromises) {
        ...
        var promise = makeUntrackedSearchParamsWithDevWarningsImpl(
          underlyingSearchParams,
          workStore,
          requestStore,
        );
    ...
    function makeUntrackedSearchParamsWithDevWarningsImpl(
      ...
      var proxiedUnderlying = instrumentSearchParamsObjectWithDevWarnings(
        underlyingSearchParams,
        workStore,
        promiseInitialized,
      );
        ...
        get: function get(target, prop, receiver) {
          ...
          if (typeof prop === 'string') {
            if (
              ...
              var expression1 = (0, _reflectutils.describeStringPropertyAccess)(
                'searchParams',
                prop,
              );
  ...
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/dynamic-access-async-storage-instance.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var dynamicAccessAsyncStorageInstance = (0,
    _asynclocalstorage.createAsyncLocalStorage)(); //# sourceMappingURL=dynamic-access-async-storage-instance.js.map
  },
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/dynamic-access-async-storage.external.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    var _dynamicaccessasyncstorageinstance = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/dynamic-access-async-storage-instance.js [app-client] (ecmascript)',
    ); //# sourceMappingURL=dynamic-access-async-storage.external.js.map
  },
  '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/request/params.js [app-client] (ecmascript)',
  (__turbopack_context__, module, exports) => {
    'use strict';
    ...
    _export(exports, {
      ...
      createPrerenderParamsForClientSegment:
        function createPrerenderParamsForClientSegment1() {
      ...
      createServerParamsForServerSegment:
        function createServerParamsForServerSegment1() {
    ...
    var _dynamicaccessasyncstorageexternal = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/dynamic-access-async-storage.external.js [app-client] (ecmascript)',
    );
    var _stagedrendering = __turbopack_context__.r(
      '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/staged-rendering.js [app-client] (ecmascript)',
    ...
    var fallbackParamsProxyHandler = {
      get: function get(target, prop, receiver) {
        if (prop === 'then' || prop === 'catch' || prop === 'finally') {
          var originalMethod = _reflect.ReflectAdapter.get(
            target,
            prop,
            receiver,
          );
    ...
    function makeDynamicallyTrackedParamsWithDevWarnings(
      ...
      // supports copying with spread and we don't want to unnecessarily
      // instrument the promise with spreadable properties of ReactPromise.
      var promise1 = hasFallbackParams
      ...
      var proxiedPromise = instrumentParamsPromiseWithDevWarnings(
        underlyingParams,
        promise1,
        workStore,
      );
  ...
  (__turbopack_context__, module, exports) => {
    ...
    function ClientPageRoot(param) {
      var Component = param.Component,
        serverProvidedParams = param.serverProvidedParams;
      var searchParams;
      var params;
      if (serverProvidedParams !== null) {
        ...
        var layoutRouterContext = (0, _react.use)(
          _approutercontextsharedruntime.LayoutRouterContext,
        );
        params =
      ...
      if (typeof window === 'undefined') {
        var workAsyncStorage = __turbopack_context__.r(
          '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/app-render/work-async-storage.external.js [app-client] (ecmascript)',
        ).workAsyncStorage;
        ...
        var createSearchParamsFromClient = __turbopack_context__.r(
          '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/request/search-params.js [app-client] (ecmascript)',
        ).createSearchParamsFromClient;
        clientSearchParams = createSearchParamsFromClient(searchParams, store);
        var createParamsFromClient = __turbopack_context__.r(
          '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/server/request/params.js [app-client] (ecmascript)',
        ...
        var createRenderSearchParamsFromClient = __turbopack_context__.r(
          '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/search-params.browser.js [app-client] (ecmascript)',
        ).createRenderSearchParamsFromClient;
        var clientSearchParams1 =
          createRenderSearchParamsFromClient(searchParams);
        var createRenderParamsFromClient = __turbopack_context__.r(
          '[project]/Documents/priya-profile/priya-new-site/node_modules/next/dist/client/request/params.browser.js [app-client] (ecmascript)',
        ).createRenderParamsFromClient;
    ...
    function ClientSegmentRoot(param) {
      ...
      if (typeof window === 'undefined') {
        ...
        return /*#__PURE__*/ (0, _jsxruntime.jsx)(
          Component,
          _object_spread_props._(_object_spread._({}, slots), {
            params: clientParams,
          }),
        );
      } else {
...
//# sourceMappingURL=82d99_next_dist_de072c54._.js.map
