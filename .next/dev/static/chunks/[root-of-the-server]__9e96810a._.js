(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (__turbopack_context__) => {
    ...
    function connect(param) {
      var addMessageListener = param.addMessageListener,
        sendMessage = param.sendMessage,
        _param_onUpdateError = param.onUpdateError,
        onUpdateError =
          _param_onUpdateError === void 0
            ? console.error
            : _param_onUpdateError;
      ...
      if (Array.isArray(queued)) {
        ...
        try {
          for (
            var _iterator = queued[Symbol.iterator](), _step;
    ...
    function handleSocketConnected(sendMessage) {
      ...
      try {
        for (
          var _iterator = updateCallbackSets.keys()[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
          var key = _step.value;
    ...
    function applyAggregatedUpdates() {
      ...
      try {
        for (
          var _iterator = chunkListsWithPendingUpdates
              .values()
              [Symbol.iterator](),
            _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
    ...
    function mergeChunkListChunks(chunksA, chunksB) {
      ...
      try {
        for (
          var _iterator = Object.entries(chunksA)[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
          var _step_value = (0,
      ...
      try {
        for (
          var _iterator1 = Object.entries(chunksB)[Symbol.iterator](), _step1;
    ...
    function mergeChunkListEcmascriptMergedUpdates(mergedA, mergedB) {
      var entries = mergeEcmascriptChunkEntries(
        mergedA.entries,
        mergedB.entries,
      );
    ...
    function mergeEcmascriptChunksUpdates(chunksA, chunksB) {
      ...
      try {
        for (
          ...
          var chunkUpdateB = chunksB[chunkPath];
          if (chunkUpdateB != null) {
            var mergedUpdate = mergeEcmascriptChunkUpdates(
              chunkUpdateA,
              chunkUpdateB,
            );
            if (mergedUpdate != null) {
    ...
    function mergeEcmascriptChunkUpdates(updateA, updateB) {
      ...
      if (updateA.type === 'deleted' && updateB.type === 'added') {
        ...
        try {
          for (
            var _iterator = addedModules[Symbol.iterator](), _step;
            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
            _iteratorNormalCompletion = true
          ) {
        ...
        try {
          for (
            var _iterator1 = deletedModules[Symbol.iterator](), _step1;
            !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done);
            _iteratorNormalCompletion1 = true
          ) {
      ...
      if (updateA.type === 'partial' && updateB.type === 'partial') {
        ...
        if (updateB.added != null) {
          ...
          try {
            for (
              var _iterator2 = updateB.added[Symbol.iterator](), _step2;
        ...
        if (updateB.deleted != null) {
          ...
          try {
            for (
              var _iterator3 = updateB.deleted[Symbol.iterator](), _step3;
      ...
      if (updateA.type === 'added' && updateB.type === 'partial') {
        ...
        try {
          for (
            var _iterator4 = (
                (_updateB_deleted1 = updateB.deleted) !== null &&
      ...
      if (updateA.type === 'partial' && updateB.type === 'deleted') {
        ...
        if (updateA.added != null) {
          ...
          try {
            for (
              var _iterator5 = updateA.added[Symbol.iterator](), _step5;
    ...
    function emitIssues() {
      ...
      try {
        for (
          var _iterator = chunksWithIssues[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
          var _step_value = (0,
            ...
            _ = _step_value[0],
            chunkIssues = _step_value[1];
          var _iteratorNormalCompletion1 = true,
            _didIteratorError1 = false,
            _iteratorError1 = undefined;
          try {
            for (
              var _iterator1 = chunkIssues[Symbol.iterator](), _step1;
              !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done);
              _iteratorNormalCompletion1 = true
            ) {
    ...
    function handleIssues(msg) {
      ...
      try {
        for (
          var _iterator = msg.issues[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
    ...
    var SEVERITY_ORDER = ['bug', 'fatal', 'error', 'warning', 'info', 'log'];
    var CATEGORY_ORDER = [
      'parse',
      'resolve',
      'code generation',
    ...
    function triggerUpdate(msg) {
      ...
      try {
        for (
          var _iterator = callbackSet.callbacks[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e96810a._.js.map
