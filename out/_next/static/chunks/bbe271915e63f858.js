(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    function f(e, t) {
      if (e.dev)
        switch (t.type) {
          ...
          case 'request':
            var r;
            return null == (r = t.cookies.get(c.NEXT_HMR_REFRESH_HASH_COOKIE))
              ? void 0
              : r.value;
        }
    }
  ...
  (e, t, r) => {
    ...
    function o(e) {
      return (
        'object' == typeof e && null !== e && 'digest' in e && e.digest === c
      );
    }
  ...
  (e, t, r) => {
    ...
    class c extends Error {
      constructor(e) {
        super('Dynamic server usage: '.concat(e)),
          (this.description = e),
          (this.digest = o);
      }
    }
  ...
  (e, t, r) => {
    ...
    function j(e) {
      let { reason: t, route: r } = e,
        n = l.workUnitAsyncStorage.getStore();
    ...
    let W = /\n\s+at Suspense \(<anonymous>\)/,
      q = new RegExp(
        '\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:'
          ...
          .concat(p.ROOT_LAYOUT_BOUNDARY_NAME, ' \\([^\\n]*\\)'),
      ),
        ...
        if (q.test(t)) {
          ...
          let a = J(
            'Route "'.concat(
              ...
              '<Suspense>. This delays the entire page from rendering, resulting in a slow user experience. Learn more: https://nextjs.org/docs/messages/blocking-route',
            t,
          );
  ...
  (e, t, r) => {
    ...
    function m() {
      return (
        null == f || f('usePathname()'), (0, o.useContext)(i.PathnameContext)
      );
    }
    function y() {
    ...
    function b() {
      return (
        null == f || f('useParams()'), (0, o.useContext)(i.PathParamsContext)
      );
    }
    function g() {
      let e =
