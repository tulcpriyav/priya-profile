(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function i(e) {
      ...
      return (
        ...
        (c = c.replace('#', '%23')),
        ''.concat(n).concat(s).concat(a).concat(c).concat(i)
      );
    }
    let u = [
      'auth',
  ...
  (e, t, r) => {
    ...
    function x(t) {
      ...
      let l,
        i,
        u,
        [d, x] = (0, c.useOptimistic)(m.IDLE_LINK_STATUS),
        j = (0, c.useRef)(null),
        {
          href: w,
          as: O,
      ...
      (l = E),
        I &&
          ...
          (l = (0, s.jsx)('a', { children: l }));
      let F = c.default.useContext(f.AppRouterContext),
        B = !1 !== P,
        q =
          !1 !== P
            ? null === (r = P) || 'auto' === r
            ...
            : b.FetchStrategy.PPR,
        { href: H, as: K } = c.default.useMemo(() => {
          let e = v(w);
          return { href: e, as: O ? v(O) : e };
        }, [w, O]);
      if (I) {
        if ((null == l ? void 0 : l.$$typeof) === Symbol.for('react.lazy'))
          throw Object.defineProperty(
            Error(
        ...
        i = c.default.Children.only(l);
      }
      let z = I ? i && 'object' == typeof i && i.ref : R,
        G = c.default.useCallback(
          (e) => (
            null !== F &&
              (j.current = (0, m.mountLinkInstance)(e, H, F, q, B, x)),
            () => {
              j.current &&
        ...
        W = {
          ...
          onMouseEnter(e) {
            I || 'function' != typeof L || L(e),
              ...
              F && B && (0, m.onNavigationIntent)(e.currentTarget, !0 === D);
          },
      ...
      return (
        (0, h.isAbsoluteUrl)(K)
          ? (W.href = K)
          : (I && !k && ('a' !== i.type || 'href' in i.props)) ||
            (W.href = (0, g.addBasePath)(K)),
        (u = I
          ? c.default.cloneElement(i, W)
          : (0, s.jsx)('a', a._(n._({}, U, W), { children: l }))),
        (0, s.jsx)(_.Provider, { value: d, children: u })
      );
    }
    e.r(84508);
    let _ = (0, c.createContext)(m.IDLE_LINK_STATUS),
      j = () => (0, c.useContext)(_);
    ('function' == typeof r.default ||
      ('object' == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
  ...
  (e, t, r) => {
    ...
    let u = e.r(63141),
      ...
      b = (e) => {
        ...
        o
          ...
          'worker' === i && p.setAttribute('type', 'text/partytown'),
          p.setAttribute('data-nscript', i),
          s &&
            ((e) => {
    ...
    function _(e) {
      ...
      (0, f.useEffect)(() => {
        let e = t || r;
        O.current || (i && e && y.has(e) && i(), (O.current = !0));
      }, [i, t, r]);
      let E = (0, f.useRef)(!1);
      if (
        ((0, f.useEffect)(() => {
          if (!E.current) {
            if ('afterInteractive' === u) b(e);
            else
              'lazyOnload' === u &&
        ...
        ('beforeInteractive' === u || 'worker' === u) &&
          (v
            ? ((x[u] = (x[u] || []).concat([
                a._(
                  n._({ id: t, src: r, onLoad: l, onReady: i, onError: s }, m),
                  { nonce: w },
                ),
              ])),
              v(x))
    ...
    Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      (r.GoogleTagManager = function (e) {
        ...
        return (
          ...
          s &&
            (f.searchParams.set('gtm_preview', s),
  ...
  (e) => {
    ...
    var t = e.i(43476),
      ...
      n = e.i(18566);
    let a = [
      { index: !0, label: 'Tulasi Priya Vattikuti', path: '/' },
    ...
    var o = e.i(71645),
      l = e.i(74080);
    let i = 'a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])';
    function u(e) {
      let {
          id: r,
          isOpen: n,
      ...
      (0, o.useEffect)(() => {
        ...
        (0, o.useEffect)(() => {
          if (n) {
            ...
            let t = null == (e = s.current) ? void 0 : e.querySelectorAll(i);
            (null == t ? void 0 : t.length) && t[0].focus();
          } else c.current && (c.current.focus(), (c.current = null));
        }, [n]);
      let d = (0, o.useCallback)((e) => {
        var t;
        if ('Tab' !== e.key) return;
        let r = null == (t = s.current) ? void 0 : t.querySelectorAll(i);
    ...
    function c() {
      ...
      let d = (0, o.useCallback)(() => n((e) => !e), []),
        f = (0, o.useCallback)(() => n(!1), []),
        p = (0, t.jsx)(u, {
          id: s,
          isOpen: e,
          onClose: f,
              ...
              (0, t.jsx)(
                'li',
                {
                  children: (0, t.jsx)(r.default, {
                    ...
                    onClick: f,
                    children: (0, t.jsx)('h3', {
                      className: e.index ? 'index-li' : void 0,
                      children: e.label,
                    }),
                  }),
                },
      ...
      return (0, t.jsxs)(t.Fragment, {
        children: [
          ...
          i && (0, l.createPortal)(p, document.body),
        ],
      });
    }
    function d(e) {
      let { size: r = 20, className: n } = e;
      return (0, t.jsxs)('svg', {
        ...
        children: [
          ...
          (0, t.jsx)('line', { x1: '12', y1: '1', x2: '12', y2: '3' }),
          (0, t.jsx)('line', { x1: '12', y1: '21', x2: '12', y2: '23' }),
          (0, t.jsx)('line', {
            x1: '4.22',
            y1: '4.22',
            x2: '5.64',
          ...
          (0, t.jsx)('line', { x1: '1', y1: '12', x2: '3', y2: '12' }),
          (0, t.jsx)('line', { x1: '21', y1: '12', x2: '23', y2: '12' }),
          (0, t.jsx)('line', {
            x1: '4.22',
            y1: '19.78',
            x2: '5.64',
    ...
    function p() {
      ...
      return null === e
        ? (0, t.jsx)('div', { className: 'theme-toggle-placeholder' })
        : (0, t.jsx)('button', {
            type: 'button',
            ...
            children: (0, t.jsx)('span', {
              ...
              children: e ? (0, t.jsx)(d, {}) : (0, t.jsx)(f, {}),
            }),
          });
    }
    function h() {
      let e = (0, n.usePathname)(),
        o = (t) =>
          '/' === t ? '/' === e : null == e ? void 0 : e.startsWith(t);
            ...
            children: a
              ...
              .map((e) =>
                (0, t.jsx)(
                  ...
                  {
                    href: e.path,
                    className: 'nav-link '.concat(o(e.path) ? 'active' : ''),
                    'aria-current': o(e.path) ? 'page' : void 0,
                    children: e.label,
                  },
                  e.label,
                ),
